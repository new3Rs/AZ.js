...
class PlayController {
    ...
    updateClock() {
        if (this.fisherRule) {
            ...
            const $playedTimer = $(this.isSelfPlay ? this.board.turn === JGO.BLACK ? '#right-clock' : '#left-clock' : played === this.board.ownColor ? '#right-clock' : '#left-clock');
